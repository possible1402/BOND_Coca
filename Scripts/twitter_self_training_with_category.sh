...
self_training_period=50
self_training_begin_step=650
model_type=roberta
self_training_reinit=0
self_training_label_mode=hard
self_training_hp_label_category=1
num_train_epochs=20
OUTPUT=outputs/twitter/self_training/${model_type}_reinit${self_training_reinit}_begin${self_training_begin_step}_period${self_training_period}_${self_training_label_mode}_hplabelcategory${self_training_hp_label_category}_${num_train_epochs}_${learning_rate}/
python ../run_self_training_ner.py \
--data_dir dataset/twitter_distant/ \
